...
<style>
	.result { padding: var(--space-5); } header { display: flex; justify-content: space-between; gap: var(--space-4); align-items: center; margin-bottom: var(--space-4); } .eyebrow { color: var(--blue-700); font-weight: 700; } .cat { color: var(--blue-600); font: 700 var(--text-xl)/1 var(--font-mono); } label { display: block; margin-top: var(--space-4); } textarea { overflow-wrap: anywhere; font-family: var(--font-mono); } .actions { display: flex; flex-wrap: wrap; gap: var(--space-2); margin-block: var(--space-3) var(--space-5); } .button-link { display: inline-flex; min-height: 2.75rem; align-items: center; padding: var(--space-2) var(--space-4); border: 1px solid var(--border-strong); border-radius: var(--radius-sm); background: var(--surface); font-weight: 700; text-decoration: none; box-shadow: var(--shadow-keyline); } .details { display: grid; grid-template-columns: minmax(10rem, 14rem) 1fr; gap: var(--space-5); align-items: start; } dl { margin: 0; } dl div { padding: var(--space-3); border-bottom: 1px solid var(--border); } dt { color: var(--ink-muted); font-size: var(--text-sm); } dd { margin: 0; font-weight: 700; } .creator { margin-top: var(--space-5); padding-top: var(--space-4); border-top: 1px solid var(--border); } .creator h3 { margin-bottom: var(--space-2); font-size: var(--text-base); } .creator p { margin-bottom: var(--space-3); color: var(--ink-muted); } .new { display: inline-block; margin-top: var(--space-4); } @media (max-width: 35rem) { .result { padding: var(--space-4); } .details { grid-template-columns: 1fr; } .actions > * { width: 100%; justify-content: center; } }
</style>
